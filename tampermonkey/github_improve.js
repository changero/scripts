...
(function () {
  ...
  const download_url_us = [
      [
        'https://ghdl.z-o.top/https://github.com',
        '美国',
        '[美国 Cloudflare CDN] - 该公益加速源由 [feizhuqwq.com] 提供',
      ],
      [
        'https://gh2.yanqishui.work/https://github.com',
        '美国',
        '[美国 Cloudflare CDN] - 该公益加速源由 [@HongjieCN] 提供',
      ],
      [
      ...
      [
        'https://gh-proxy-misakano7545.koyeb.app/https://github.com',
        '美国',
        '[美国 Cloudflare CDN]',
      ],
      ...
      [
        'https://download.xn--p8jhe.tw',
        '美国',
        '[美国 圣何塞]',
        'https://archive.xn--p8jhe.tw',
      ],
    ],
    download_url = [
      ...
      [
        ...
        '日本',
        '[日本 东京] - 该公益加速源由 [FastGit] 提供',
        'https://archive.fastgit.org',
      ],
      [
        'https://mirror.ghproxy.com/https://github.com',
        '日本',
        '[日本 东京] - 该公益加速源由 [ghproxy] 提供',
      ],
      [
    ...
    raw_url = [
      ...
      [
        ...
        '日本 2',
        '[日本 东京] - 该公益加速源由 [Statically CDN] 提供&#10;&#10; - 缓存：有&#10; - 不支持大小超过 30 MB 的文件',
      ],
      [
      ...
      [
        'https://raw.xn--gzu630h.xn--kpry57d',
        '韩国',
        '[韩国 首尔]&#10;&#10; - 缓存：无（或时间很短）',
      ],
  ...
  function get_New_download_url() {
    let a = Math.floor(Math.random() * download_url_us.length),
      b,
      new_download_url = [];
    do {
      b = Math.floor(Math.random() * download_url_us.length);
    } while (b == a);
  ...
  function addRelease() {
    ...
    if (html.length == 0 || location.pathname.indexOf('/releases') == -1)
      return;
    ...
    for (const current of html) {
      ...
      current.querySelectorAll('li.Box-row a').forEach(function (_this) {
        ...
        for (let i = 0; i < new_download_url.length; i++) {
          if (
            new_download_url[i][3] !== undefined &&
          ...
          if (location.host !== 'github.com')
            url = url.replace(location.host, 'github.com');
  ...
  function addRawFile() {
    ...
    for (let i = 1; i < raw_url.length; i++) {
      if (raw_url[i][0].indexOf('jsdelivr.net') != -1) {
        ...
        raw_url[i][0].indexOf('futils.com') != -1 ||
        raw_url[i][0].indexOf('fsofso.com') != -1
      ) {
  ...
  function addRawDownLink() {
    ...
    files.forEach(function (fileElm, i) {
      ...
      if (raw_url[menu_raw_fast][0].indexOf('jsdelivr.net') != -1) {
        ...
        raw_url[menu_raw_fast][0].indexOf('futils.com') != -1 ||
        raw_url[menu_raw_fast][0].indexOf('fsofso.com') != -1
      ) {
